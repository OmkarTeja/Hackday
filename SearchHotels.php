...
<div class="w3-row-padding w3-center w3-margin-top">
            <div class="row">
                ...
                <div class="col-sm-4" style='text-align:center'>
                    <form class="w3-container w3-card-4" action="SetUserDetails.php" method="post">
                        <h4> </h4><br>
                        ...
                        <p><button class="w3-btn w3-red w3-hover-green" type='submit' name='searchButton'>Search</button></p>
                        <br>
                    </form>
                </div>
                <div class="col-sm-4"></div>
